...
3. **תקופת ההלוואה (בחודשים)** - למשל 144, 240, 300, 360
...
| מה כתוב במסמך | type |
|---------------|------|
| פריים / פריים דיור / פריים דיור - דיור | prime |
| קבועה לא צמודה / ריבית קבועה לא צמודה / קבועה לא צמודה בחלקים | fixed_unlinked |
| קבועה צמודה / צמודה - דיור / ריבית קבועה צמודה | fixed_linked |
| משתנה לא צמודה / משתנה לא צמודה כל X שנים / משתנה 2+2 / משתנה על בסיס אג"ח | variable_unlinked |
...
סה"כ: 430,000
- מסלול 1: פריים דיור - דיור, 136,000 ש"ח, 144 חודשים, מתואמת 4.8%
- מסלול 2: קבועה לא צמודה בחלקים, 147,000 ש"ח, 144 חודשים, מתואמת 4.53%
- מסלול 3: משתנה לא צמודה 2+2, 147,000 ש"ח, 144 חודשים, מתואמת 4.59%

### דוגמה 2 - מסמך עם 3 מסלולים:
סה"כ: 750,000
- מסלול 1: ריבית קבועה לא צמודה - דיור, 300,000 ש"ח, 300 חודשים, מתואמת 4.75%
- מסלול 2: משתנה לא צמודה 2+2, 300,000 ש"ח, 312 חודשים, מתואמת 4.7%
- מסלול 3: פריים דיור - דיור, 150,000 ש"ח, 300 חודשים, מתואמת 4.8%

### דוגמה 3 - מסמך עם 3 מסלולים:
סה"כ: 1,200,000
- מסלול 1: קבועה לא צמודה, 400,000 ש"ח, 240 חודשים, מתואמת 4.55%
- מסלול 2: משתנה פריים, 480,000 ש"ח, 360 חודשים, מתואמת 4.6%
- מסלול 3: משתנה לא צמודה כל שנה, 320,000 ש"ח, 360 חודשים, מתואמת 4.34%
